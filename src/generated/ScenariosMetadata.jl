...
function ScenariosMetadata(label, resolution, initial_time, scenario_count, time_series_uuid, horizon, scaling_factor_multiplier=nothing, )
    ScenariosMetadata(label, resolution, initial_time, scenario_count, time_series_uuid, horizon, scaling_factor_multiplier, InfrastructureSystemsInternal(), )
end

function ScenariosMetadata(; label, resolution, initial_time, scenario_count, time_series_uuid, horizon, scaling_factor_multiplier=nothing, internal=InfrastructureSystemsInternal(), )
    ScenariosMetadata(label, resolution, initial_time, scenario_count, time_series_uuid, horizon, scaling_factor_multiplier, internal, )
end
...
"""Get [`ScenariosMetadata`](@ref) `initial_time`."""
get_initial_time(value::ScenariosMetadata) = value.initial_time
...
"""Set [`ScenariosMetadata`](@ref) `initial_time`."""
set_initial_time!(value::ScenariosMetadata, val) = value.initial_time = val
